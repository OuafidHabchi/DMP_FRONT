...
const Contact = () => {
  ...
  const thankYouMessage = isEnglish
    ? 'Thank you for using OPEX LOGISTICS. Use this page to communicate anything related to the management of your DSP.'
    : 'Merci d\'utiliser OPEX LOGISTICS. Utilisez cette page pour nous communiquer tout ce qui concerne le management de votre DSP.';
