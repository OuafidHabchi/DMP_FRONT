...
const ExtraRoadEmployee = () => {
    ...
    const openModal = async (road: Road) => {
        ...
        try {
            const updatedRoad = {
                ...road,
                seen: road.seen.includes(user._id) ? road.seen : [...road.seen, user._id],
            };
    ...
    const handleInterested = async () => {
        if (selectedRoad) {
            try {
                const updatedRoad = {
                    ...selectedRoad,
                    interested: [...selectedRoad.interested, user._id],
                };
    ...
    const handleNotInterested = async () => {
        if (selectedRoad) {
            try {
                const updatedRoad = {
                    ...selectedRoad,
                    notInterested: [...selectedRoad.notInterested, user._id],
                };
