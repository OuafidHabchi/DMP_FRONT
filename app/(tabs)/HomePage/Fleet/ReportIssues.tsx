...
import { StyleSheet, Text, View, FlatList, TouchableOpacity, Modal, Button, TextInput, Switch, Alert, Platform, RefreshControl, ActivityIndicator } from 'react-native';
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>
          {user.language === 'English' ? 'Fleet Management' : 'Gestion de la Flotte'}
        </Text>
        {Platform.OS === 'web' && (
