  ...
  const handleCreateRoad = async () => {
    ...
    try {
      ...
      const newRoad: Road = {
        ...
        seen: [], // Valeur par défaut
        interested: [], // Valeur par défaut
        notInterested: [], // Valeur par défaut
              ...
              >
                <View style={styles.roadInfo}>
                  ...
                  <Text style={styles.roadDetails}>
                    {user.language === 'English' ? 'Road Number' : 'nembre des routes'}: {item.roadNumber}
                  </Text>
                  <Text style={styles.roadDetails}>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <TextInput
              style={styles.input}
              placeholder={
                user.language === 'English' ? 'Road number' : 'nembre des routes'
              }
                ...
                onPress={async () => {
                  if (selectedRoad) {
                    try {
                      ...
                      alert('Error updating road. Please try again.');
                    }
                  }
                }}
              >
                ...
                onPress={async () => {
                  if (selectedRoad) {
                    try {
                      ...
                      alert('Error deleting road. Please try again.');
                    }
                  }
                }}
              >
